  ...
  theme: {
    extend: {
      colors: {
        ...
        free: {
          DEFAULT: 'hsl(var(--color-free) / <alpha-value>)',
          light: 'hsl(var(--color-free-light) / <alpha-value>)',
          dark: 'hsl(var(--color-free-dark) / <alpha-value>)',
          bg: 'hsl(var(--color-free-bg) / <alpha-value>)',
        },
        premium: {
          DEFAULT: 'hsl(var(--color-premium) / <alpha-value>)',
          light: 'hsl(var(--color-premium-light) / <alpha-value>)',
          dark: 'hsl(var(--color-premium-dark) / <alpha-value>)',
          bg: 'hsl(var(--color-premium-bg) / <alpha-value>)',
        },
      },
      fontFamily: {
